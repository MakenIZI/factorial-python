# Calcular el factorial "!n" en Python:
...
El programa solicita un número al usuario, valida la lógica y genera una salida formateada:


Dime de qué número quieres el factorial: 5
